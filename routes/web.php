...
Route::middleware(['auth:web', 'XSS'])->name('admin.')->namespace('Admin')->prefix('admin')->group(function () {
    ...
    // Student Clearance
    Route::resource('student-clearance', 'StudentClearanceController');
    Route::get('student/update/clearance/{id}', 'StudentClearanceController@update')->name('clearance.update');
...
Route::middleware(['auth:student', 'XSS'])->prefix('student')->name('student.')->namespace('Student')->group(function () {
    ...
    Route::get('student/clearance', 'StudentClearanceController@index')->name('clearance.index');
    Route::post('student/clearance/update/{id}', 'StudentClearanceController@update')->name('clearance.update');
    ...
    Route::post('fees', 'FeesController@pay')->name('fees.pay');
