...
<div class="navbar-content scroll-div ps ps--active-y">
    <ul class="nav pcoded-inner-navbar">
        ...
        @canany(['application-create', 'application-view', 'student-create', 'student-view', 'student-password-print',
            'student-password-change', 'student-card', 'student-transfer-in-create', 'student-transfer-in-view',
            'student-transfer-out-create', 'student-transfer-out-view', 'status-type-create', 'status-type-view',
            'id-card-setting-view'])
                ...
                <ul class="pcoded-submenu">
                    ...
                    @canany(['student-view', 'student-password-print', 'student-password-change', 'student-card'])
                        <li class="{{ Request::is('admin/admission/student') ? 'active' : '' }}"><a
                                href="{{ route('admin.student.index') }}" class="">{{ trans_choice('module_student', 1) }}
                                {{ __('list') }}</a></li>
                    @endcanany
        ...
        @canany(['student-attendance-action', 'student-attendance-report', 'student-leave-manage-view',
            ...
            <li class="nav-item pcoded-hasmenu {{ Request::is('admin/student*') ? 'pcoded-trigger active' : '' }}">
                ...
                <ul class="pcoded-submenu">
                    <li class="{{ Request::is('admin/student-clearance*') ? 'active' : '' }}">
                        <a href="{{ route('admin.student-clearance.index') }}">Clearance</a>
                    </li>
                </ul>
            </li>
        @endcanany
            ...
            <li class="nav-item pcoded-hasmenu {{ Request::is('admin/fees*') ? 'pcoded-trigger active' : '' }}">
                ...
                <ul class="pcoded-submenu">
                    ...
                    @canany(['fees-fine-view', 'fees-fine-create', 'fees-receipt-view'])
                        <li
                            class="nav-item pcoded-hasmenu {{ Request::is('admin/fees-fine*') ? 'pcoded-trigger active' : '' }} {{ Request::is('admin/fees-receipt*') ? 'pcoded-trigger active' : '' }}">
                            <a href="#!" class="nav-link">
                                <span class="pcoded-mtext">{{ trans_choice('module_setting', 2) }}</span>
                            </a>
                ...
                <ul class="pcoded-submenu">
                    @canany(['book-issue-return-action', 'book-issue-return-view'])
                        <li class="{{ Request::is('admin/library/issue-return') ? 'active' : '' }}"><a
                                ...
                                class="">{{ trans_choice('module_issue_return', 1) }}</a></li>
                    @endcanany

                    @can('book-issue-return-over')
                        <li class="{{ Request::is('admin/library/issue-return-over') ? 'active' : '' }}"><a
                                href="{{ route('admin.issue-return.over') }}"
                                class="">{{ trans_choice('module_return_date_over', 1) }}</a></li>
                    @endcan
                ...
                <ul class="pcoded-submenu">
                    @canany(['item-issue-action', 'item-issue-view'])
                        <li class="{{ Request::is('admin/inventory/item-issue*') ? 'active' : '' }}"><a
                                ...
                                class="">{{ trans_choice('module_item_issue', 2) }}</a></li>
                    @endcanany
        ...
        @canany(['setting-view', 'province-view', 'province-create', 'district-view', 'district-create',
            ...
            'sms-setting-view', 'application-setting-view', 'schedule-setting-view', 'bulk-import-export-view', 'role-view',
            'role-edit', 'field-staff', 'field-student', 'field-application', 'student-panel-view'])
            <li
                ...
                @endcan --}}
                    ...
                    @canany(['role-view', 'role-edit'])
                        <li class="{{ Request::is('admin/setting/role*') ? 'active' : '' }}"><a
                                href="{{ route('admin.role.index') }}" class="">{{ trans_choice('module_role', 2) }}</a>
                        </li>
                    @endcanany
